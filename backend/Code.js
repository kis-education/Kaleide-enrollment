 ...
 */
/**
 * Sends an email FROM the admissions@ alias using Gmail Advanced Service (raw RFC822).
 * Requires gmail.send scope only (no CASA). Gmail server verifies the From: alias.
